...
*/
import { assert, getFactoryId, PollyError, MODES, ACTIONS, EXPIRY_STRATEGIES, Serializers } from '@pollyjs/utils';
...
class Adapter {
  ...
  assert(message, ...args) {
    assert(`[${this.constructor.type}:${getFactoryId(this.constructor)}] ${message}`, ...args);
  }
