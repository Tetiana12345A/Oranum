/**
* @pollyjs/adapter-puppeteer v4.3.0
*
...
(function (global, factory) {
  ...
  (global = global || self, global['@pollyjs/adapter-puppeteer'] = factory());
  ...
  function getFactoryId(Factory) {
    ...
    console.warn("[Polly] ".concat(Factory.name, " \"name\" is deprecated and has been renamed to \"id\"."));
    return Factory.name;
  }
  ...
  function () {
    ...
    createClass(Adapter, [{
      ...
      value: function assert(message) {
        ...
        _assert.apply(void 0, ["[".concat(this.constructor.type, ":").concat(getFactoryId(this.constructor), "] ").concat(message)].concat(args));
      }
    }, {
      key: "onConnect",
      ...
      key: "options",
      get: function get() {
        return objectSpread({}, this.defaultOptions || {}, (this.polly.config.adapterOptions || {})[getFactoryId(this.constructor)] || {});
      }
    }, {
      key: "persister",
      get: function get() {
  ...
  var LISTENERS = symbol$1();

  var PASSTHROUGH_PROMISES = symbol$1();

  var PASSTHROUGH_REQ_ID_QP = 'pollyjs_passthrough_req_id';

  var PuppeteerAdapter =
  /*#__PURE__*/
  function (_Adapter) {
    inherits(PuppeteerAdapter, _Adapter);

    createClass(PuppeteerAdapter, [{
      key: "defaultOptions",
      get: function get() {
        return {
          page: null,
    ...
    function PuppeteerAdapter() {
      var _this;

      classCallCheck(this, PuppeteerAdapter);

      _this = possibleConstructorReturn(this, getPrototypeOf$2(PuppeteerAdapter).apply(this, arguments));
      _this._requestsMapping = {
        passthroughs: new weakMap$1(),
        pollyRequests: new weakMap$1()
      };
      return _this;
    }
    ...
    createClass(PuppeteerAdapter, [{
      ...
      value: function onConnect() {
        ...
        this[LISTENERS] = new map$1();
        this[PASSTHROUGH_PROMISES] = new map$1();
        this.assert('A puppeteer page instance is required.', !!(page && _typeof_1(page) === 'object'));
      ...
      value: function onDisconnect() {
        ...
        this[LISTENERS].forEach(function (_, target) {
          return _this2._callListenersWith('removeListener', target);
        });
      }
    }, {
      key: "attachToPageEvents",
      value: function attachToPageEvents(page) {
        var _this3 = this;

        var requestResourceTypes = this.options.requestResourceTypes;
        this[LISTENERS].set(page, {
          request: function () {
            var _request2 = asyncToGenerator(
            /*#__PURE__*/
            regenerator.mark(function _callee(_request) {
              var url, method, headers, isPreFlightReq, parsedUrl;
              return regenerator.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      if (requestResourceTypes.includes(_request.resourceType())) {
                        url = _request.url();
                        method = _request.method();
                        headers = _request.headers(); // A CORS preflight request is a CORS request that checks to see
                        // if the CORS protocol is understood.

                        isPreFlightReq = method === 'OPTIONS' && !!headers['origin'] && !!headers['access-control-request-method']; // Do not intercept requests with the Polly passthrough QP

                        if (url.includes(PASSTHROUGH_REQ_ID_QP)) {
                          parsedUrl = new URL(url, true); // If this is a polly passthrough request
                          // Get the associated promise object for the request id and set it
                          // on the request.

                          if (!isPreFlightReq) {
                            _this3._requestsMapping.passthroughs.set(_request, _this3[PASSTHROUGH_PROMISES].get(parsedUrl.query[PASSTHROUGH_REQ_ID_QP]));
                          } // Delete the query param to remove any pollyjs footprint


                          delete parsedUrl.query[PASSTHROUGH_REQ_ID_QP]; // Continue the request with the url override
                          ...
                          _this3.handleRequest({
                            headers: headers,
                            url: url,
                            method: method,
                            body: _request.postData(),
                            requestArguments: {
                              request: _request
                            }
                          });
          ...
          requestfinished: function requestfinished(request) {
            var response = request.response();
            var _this3$_requestsMappi = _this3._requestsMapping,
                passthroughs = _this3$_requestsMappi.passthroughs,
                pollyRequests = _this3$_requestsMappi.pollyRequests; // Resolve the passthrough promise with the response if it exists
          ...
          requestfailed: function requestfailed(request) {
            var error = request.failure();
            var _this3$_requestsMappi2 = _this3._requestsMapping,
                passthroughs = _this3$_requestsMappi2.passthroughs,
                pollyRequests = _this3$_requestsMappi2.pollyRequests; // Reject the passthrough promise with the error object if it exists
          ...
          close: function close() {
            return _this3[LISTENERS].delete(page);
          }
        });
      ...
      value: function onRequest(pollyRequest) {
        var request = pollyRequest.requestArguments.request;
        var promise = pollyRequest.promise; // Override the deferred promise's resolve and reject to no-op since
      ...
      value: function () {
        ...
        regenerator.mark(function _callee2(pollyRequest) {
          ...
          var page, id, order, url, method, headers, body, requestId, parsedUrl, response;
          return regenerator.wrap(function _callee2$(_context2) {
            while (1) {
              switch (_context2.prev = _context2.next) {
                case 0:
                  page = this.options.page;
                  id = pollyRequest.id, order = pollyRequest.order, url = pollyRequest.url, method = pollyRequest.method, headers = pollyRequest.headers, body = pollyRequest.body;
                  requestId = "".concat(this.polly.recordingId, ":").concat(id, ":").concat(order);
                  parsedUrl = new URL(url, true);
                  parsedUrl.query[PASSTHROUGH_REQ_ID_QP] = requestId;
                  _context2.prev = 5;
                  _context2.next = 8;
                  return new promise$1(function (resolve, reject) {
                    _this4[PASSTHROUGH_PROMISES].set(requestId, {
                      resolve: resolve,
                      reject: reject
                    ...
                    page.evaluate(new Function('url', 'method', 'headers', 'body', 'return fetch(url, { method, headers, body });'), parsedUrl.toString(), method, headers, body);
                  });

                case 8:
                  response = _context2.sent;
                  _context2.t0 = response.status();
                  _context2.t1 = response.headers();
                  _context2.next = 13;
        ...
        return function passthroughRequest(_x2) {
          return _passthroughRequest.apply(this, arguments);
        };
      }()
    }, {
      ...
      value: function () {
        var _respondToRequest = asyncToGenerator(
        /*#__PURE__*/
        regenerator.mark(function _callee3(pollyRequest, error) {
          var request, response;
          return regenerator.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  request = pollyRequest.requestArguments.request;
                  response = pollyRequest.response;
        ...
        return function respondToRequest(_x3, _x4) {
          return _respondToRequest.apply(this, arguments);
        };
      }()
    }, {
      key: "_callListenersWith",
      value: function _callListenersWith(methodName, target) {
        if (this[LISTENERS].has(target)) {
          var listeners = this[LISTENERS].get(target);
...
//# sourceMappingURL=pollyjs-adapter-puppeteer.js.map
