...
(function (global, factory) {
	...
	function keyFor(Factory) {
	  return "".concat(Factory.type, ":").concat(getFactoryId(Factory));
	}
	...
	function () {
	  ...
	  createClass(Polly, [{
	    ...
	    key: "connectTo",
	    value: function connectTo(idOrFactoryIdGetter) {
	      var container = this.container,
	          adapters = this.adapters;
	      var adapterId = idOrFactoryIdGetter;
	    ...
	    key: "disconnectFrom",
	    value: function disconnectFrom(idOrFactoryIdGetter) {
