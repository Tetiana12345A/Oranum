...
class Persister {
  ...
  get options() {
    return objectSpread({}, this.defaultOptions || {}, (this.polly.config.persisterOptions || {})[utils.getFactoryId(this.constructor)] || {});
  }
  ...
  async persist() {
    ...
    const creator = {
      ...
      comment: `${this.constructor.type}:${utils.getFactoryId(this.constructor)}`
    };
  ...
  assert(message, ...args) {
    utils.assert(`[${this.constructor.type}:${utils.getFactoryId(this.constructor)}] ${message}`, ...args);
  }
  /**
